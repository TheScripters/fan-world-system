...
if (isset($_SESSION['logged_in']) && !isset($_GET['user']))
  {
    ...
    $Profile = mysql_fetch_array(mysql_query("SELECT * FROM ".$table."users WHERE UserId = '".$UserID."'"));
...
if (isset($_GET['user']))
  {
    ...
    $Profile_View = mysql_query("SELECT * FROM ".$table."users WHERE UserId = '".$UserView."'");
