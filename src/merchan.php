...
if (!$_GET['mode']){
	...
	$membercount = mysql_fetch_array(mysql_query("SELECT COUNT(*) AS memcnt FROM ".$table."merchandise"));
	...
	$memberlist = mysql_query("SELECT * FROM ".$table."merchandise ORDER BY ID ASC LIMIT $page,30"); 
