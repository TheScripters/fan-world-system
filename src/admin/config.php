...
$keyword = mysql_fetch_array(mysql_query("SELECT Config_Value FROM ".$table."config WHERE Config_ID = 'Keywords'"));
$description = mysql_fetch_array(mysql_query("SELECT Config_Value FROM ".$table."config WHERE Config_ID = 'Description'"));
?>
      <table align="center">
...
else
 {
   ...
   $sql = mysql_query("UPDATE ".$table."config SET Config_Value = '".$keyword."' WHERE Config_ID = 'Keywords'");
   $sql = mysql_query("UPDATE ".$table."config SET Config_Value = '".$descrip."' WHERE Config_ID = 'Description'");
