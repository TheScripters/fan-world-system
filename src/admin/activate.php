...
if (!$_GET['mode']){
  ...
  $act = mysql_fetch_array(mysql_query("SELECT Config_Value FROM ".$table."config WHERE Config_ID = 'ActivateSend'"));
...
elseif ($_GET['mode'] == "update"){
  $sql = mysql_query("UPDATE ".$table."config SET Config_Value = '".$_REQUEST['freq'].",".$_REQuEST['lastsent'].",".$_REQUEST['nextsend']."' WHERE Config_ID = 'ActivateSend'");
