...
$admin_main = mysql_fetch_array(mysql_query("SELECT Config_Value AS msg FROM ".$table."config WHERE Config_ID = 'Admin_Message'"));
$now = time();
...
if ($msg_cnt['count'] == "0")
 ...
 else
  {
    ...
    $msgs = mysql_query("SELECT * FROM ".$table."admin_msg WHERE Date >= '".$date."' ORDER BY Msg_ID DESC");
