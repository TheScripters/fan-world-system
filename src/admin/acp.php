...
if (!$_GET['mode']){
  $msg = mysql_fetch_array(mysql_query("SELECT Config_Value FROM ".$table."config WHERE Config_ID = 'Admin_Message'"));
  ?>
...
elseif ($_GET['mode'] == "update"){
  ...
  $sql = mysql_query("UPDATE ".$table."config SET Config_Value = '".$message."' WHERE Config_ID = 'Admin_Message'");
