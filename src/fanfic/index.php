...
incheader("Home");
$story = mysql_fetch_array(mysql_query("SELECT COUNT(*) AS cnt FROM ".$table."fftitles"));
$story_s = ($story['cnt'] == 1) ? "story" : "stories";
$chap = mysql_fetch_array(mysql_query("SELECT COUNT(*) AS cnt FROM ".$table."ffchapter"));
?><br>
