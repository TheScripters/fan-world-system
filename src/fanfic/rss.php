...
<rss version="2.0">
  <channel>
    ...
    <?php $result = mysql_query("SELECT * FROM ".$table."ffchapter ORDER BY Date DESC LIMIT 0,$rss");
    while($myrow = mysql_fetch_array($result))
       {
         $ficTitle = mysql_fetch_array(mysql_query("SELECT * FROM ".$table."fftitles WHERE FF_Id = '".$myrow['FicId']."'"));
         echo "\t\t<item>\n";
         echo "\t\t\t<title>";
         echo $ficTitle['Title'];
         echo "</title>\n";
