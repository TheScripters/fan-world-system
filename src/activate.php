...
$Actsql = mysql_query("SELECT Act_Key, UserName FROM ".$table."users WHERE UserId = '$UserId'");
...
if ($Act_Key == $ActKey['Act_Key'])
  {
    ...
    $sql = mysql_query("UPDATE ".$table."users SET Active = '1', Act_Key = '', IP_Login = '".$_SERVER['REMOTE_ADDR']."' WHERE UserId = '$UserId'");
