...
/*******includes/avhost.php******/
include ("db.php");
$avsql = mysql_query("SELECT * FROM ".$table."avhosting WHERE UserId = '".$_SESSION['userID']."'");//gets all of the pictures for each user
$sizes_query = mysql_query("SELECT File_Size FROM ".$table."avhosting WHERE UserId = '".$_SESSION['userID']."'");//gets all the data for the file sizes for the user
$total_size_bytes = 0;
