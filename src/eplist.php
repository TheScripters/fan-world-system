  ...
  {// If the user is NOT logged in...
    ...
    if ($_SESSION['Logged_In'] == "True")
      {// Display logout link
        ...
        $s1 = mysql_query("SELECT * FROM ".$table."eplist WHERE Season = 'Season 1' ORDER BY EpId ASC");
        ...
        // Query for S2
        $s2 = mysql_query("SELECT * FROM ".$table."eplist WHERE Season = 'Season 2' ORDER BY EpId ASC");
        // Loop for S2
        ...
        // Query for S3
        $s3 = mysql_query("SELECT * FROM ".$table."eplist WHERE Season = 'Season 3' ORDER BY EpId ASC");
        // Loop for S3
        ...
        // Query for S4
        $s4 = mysql_query("SELECT * FROM ".$table."eplist WHERE Season = 'Season 4' ORDER BY EpId ASC");
        // Loop for S4
...
if ($_GET['p'] == "login")
  {
    ...
    $login = mysql_query("SELECT UserId,Password,UserLevel FROM ".$table."users WHERE UserName = '$UName'");
...
if ($_GET['p'] == "submit")
  {
    ...
    $sql = mysql_query("INSERT INTO ".$table."eplist VALUES (NULL, '$EpNumber','$AirDate','$EpTitle', '$EpDesc', '$ProdId', 'Season $Season', '')");
    // Redirect to main page
    header("Location: eplist.php");
...
if ($_GET['p'] == "edit")
  {
    ...
    $EditEp = mysql_query("SELECT * FROM ".$table."eplist WHERE EpId = '$EpId'");
    $EpGuide = mysql_fetch_array(mysql_query("SELECT * FROM ".$table."epguide WHERE EpId = '$EpId'"));
    $Transcript = mysql_fetch_array(mysql_query("SELECT ScriptText AS Text FROM ".$table."transcript WHERE EpId = '$EpId'"));
...
if ($_GET['p'] == "editep")
  {
    ...
    $sql = mysql_query("UPDATE ".$table."eplist SET EpNumber = '$EpNumber',AirDate = '$AirDate', EpTitle = '$EpTitle', EpDesc = '$EpDesc', ProdId = '$ProdId', Season = '$Season' WHERE EpId = '$EpId'");
    $sql = mysql_query("UPDATE ".$table."epguide SET Studio = '$Studio',Writer = '$Writer',Director = '$Director',Producer = '$Producer',Executive = '$Executive',EpRecap = '$Recap' WHERE EpId = '$EpId'");
    $sql = mysql_query("UPDATE ".$table."transcript SET ScriptText = '$Transcript' WHERE EpId = '$EpId'");
