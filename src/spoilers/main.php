...
<table>
  ...
  <tr>
    <td class="spoiler"><ul><?
      $spoiler = mysql_query("SELECT * FROM ".$table."spoiler WHERE Confirmed = 'True' AND Classification = 'Plot'");
  ...
  <tr>
    <td class="spoiler"><ul><?
      $spoiler = mysql_query("SELECT * FROM ".$table."spoiler WHERE Confirmed = 'True' AND Classification = 'Episode'");
      while($plot = mysql_fetch_array($spoiler))
        {
          echo "<li class=\"spoiler\" onmouseover=\"this.style.color='#FFFFFF';return true\" onmouseout=\"this.style.color='#000000';return true\">";
          echo strip_gpc_slashes($plot['SpoilerText']);
  ...
  <tr>
    <td class="spoiler"><ul><?
      $spoiler = mysql_query("SELECT * FROM ".$table."spoiler WHERE Confirmed = 'True' AND Classification = 'Miscellaneous'");
      while($plot = mysql_fetch_array($spoiler))
        {
          echo "<li class=\"spoiler\" onmouseover=\"this.style.color='#FFFFFF';return true\" onmouseout=\"this.style.color='#000000';return true\">";
          echo strip_gpc_slashes($plot['SpoilerText']);
  ...
  <tr>
    <td class="spoiler"><ul><?
      $spoiler = mysql_query("SELECT * FROM ".$table."spoiler WHERE Confirmed = 'False' AND Classification = 'Plot'");
      while($plot = mysql_fetch_array($spoiler))
        {
          echo "<li class=\"spoiler\" onmouseover=\"this.style.color='#FFFFFF';return true\" onmouseout=\"this.style.color='#000000';return true\">";
          echo strip_gpc_slashes($plot['SpoilerText']);
  ...
  <tr>
    <td class="spoiler"><ul><?
      $spoiler = mysql_query("SELECT * FROM ".$table."spoiler WHERE Confirmed = 'False' AND Classification = 'Episode'");
      while($plot = mysql_fetch_array($spoiler))
        {
          echo "<li class=\"spoiler\" onmouseover=\"this.style.color='#FFFFFF';return true\" onmouseout=\"this.style.color='#000000';return true\">";
          echo strip_gpc_slashes($plot['SpoilerText']);
  ...
  <tr>
    <td class="spoiler"><ul><?
      $spoiler = mysql_query("SELECT * FROM ".$table."spoiler WHERE Confirmed = 'False' AND Classification = 'Miscellaneous'");
      while($plot = mysql_fetch_array($spoiler))
        {
          echo "<li class=\"spoiler\" onmouseover=\"this.style.color='#FFFFFF';return true\" onmouseout=\"this.style.color='#000000';return true\">";
          echo strip_gpc_slashes($plot['SpoilerText']);
